...
?>   
            ...
            <div class="header_widgets">
              ...
              <p class="uppercase_text">For Support Mail us : Monjurhassan44@gmail.com </p>
              <a href="mailto:<?php echo htmlentities($email);?>"><?php echo htmlentities($email);?></a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us:01625058344 </p>
...
echo "Welcome To Vehicle Subscription portal";
 } ?>
          </div>
        </div>
      </div>
